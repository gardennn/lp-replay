...
/// @notice Reference scenario T5.2 — narrow-range ETH/USDC LP across May 4 → Jun 29 2024.
/// @dev    Same window and deposit as T5.1 (`ETH_USDC_Wide_May2024.t.sol`), but the range is
///         tightened to ±500 ticks (~±5%). Expectation: more fees per dollar of liquidity, but
///         significantly more time spent out of range as ETH drifts. Use alongside T5.1 for the
///         narrow-vs-wide comparison in `docs/STRATEGY_COMPARISON.md`.
contract ETH_USDC_Narrow_May2024 is Test {
    uint256 constant START_BLOCK = 19_800_000; // 2024-05-04
    uint256 constant END_BLOCK = 20_200_000; // 2024-06-29
    int24 constant TICK_SPACING = 10;
    int24 constant HALF_WIDTH = 500;

    function test_narrowRange_ethUsdc_logsResult() public {
        ...
        console2.log("=== T5.2 narrow-range ETH/USDC (HALF_WIDTH=500) ===");
